...
7. **One fact once.** No IDs, jargon, repeated status strips or subtitles explaining obvious labels. Dates in words, numbers with units. Run results show the outcome and next action; supporting evidence is collapsible. Real blockers and missing-data warnings stay visible.
